...
urlpatterns = [
    ...
    # url(r'^subdistrict/$', views.subdistrict_list, name='subdistrict_list'),
    ...
    # url(r'^village/$', views.village_list, name='village_list'),
