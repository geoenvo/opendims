...
class WaterGate(CommonAbstractModel):
    ...
    siaga_1_min = models.PositiveIntegerField(default=0, verbose_name=verbose_siaga1min)
    siaga_1_max = models.PositiveIntegerField(default=0, verbose_name=verbose_siaga1max)
    siaga_2_min = models.PositiveIntegerField(default=0, verbose_name=verbose_siaga2min)
    siaga_2_max = models.PositiveIntegerField(default=0, verbose_name=verbose_siaga2max)
    siaga_3_min = models.PositiveIntegerField(default=0, verbose_name=verbose_siaga3min)
    siaga_3_max = models.PositiveIntegerField(default=0, verbose_name=verbose_siaga3max)
