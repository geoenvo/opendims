# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-04-06 06:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('watergate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='waterlevelreports', to='waterlevel.WaterGate', verbose_name='WaterGate')),
            ],
            options={
