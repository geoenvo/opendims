    ...
    def get_queryset(self):
        ...
        if date:
            try:
                ...
                report_4_datetime = datetime.datetime(date.year, date.month, date.day, 23)
                report_3_datetime = datetime.datetime(date.year, date.month, date.day, 17)
                report_2_datetime = datetime.datetime(date.year, date.month, date.day, 11)
                report_1_datetime = datetime.datetime(date.year, date.month, date.day, 5)
            ...
            report_4_datetime = datetime.datetime(today.year, today.month, today.day, 23)
            report_3_datetime = datetime.datetime(today.year, today.month, today.day, 17)
            report_2_datetime = datetime.datetime(today.year, today.month, today.day, 11)
            report_1_datetime = datetime.datetime(today.year, today.month, today.day, 5)
